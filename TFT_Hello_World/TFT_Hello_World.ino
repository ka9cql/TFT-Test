 ...
 *
 * SETUP INSTRUCTIONS:
 * 1. Install TFT_eSPI library via Library Manager
 * 2. Copy User_Setup.h to your Arduino/libraries/TFT_eSPI/ folder
 *    (This configures the pins for XIAO ESP32S3)
 ...
 * 4. Select Board: Tools > Board > ESP32 Arduino > XIAO_ESP32S3
...
// Pin definitions (configured in User_Setup.h)
#define TFT_MISO 8
#define TFT_MOSI 9
#define TFT_SCLK 7
#define TFT_CS   3
...
void setup() {
  ...
  Serial.println("  Arduino IDE 2.3.7");
  Serial.println("═══════════════════════════════════════");
